...
save_link_Config := "..\config.ini"
save_link_forceImage := "..\ForceImage"
load_data := FileExist(save_link_Config)
...
if (base_config == "No ESix") {
    ...
    board_link.AddPicture("w" . Integer(width_ui/2) . " h" . Integer(height_ui/1.8), save_link_Config . "icon_on_lost_link.png")
    ...
    check_link(*) {
        (save_link_Config == "") ? (
            ...
            IniWrite(save_link_Config, "config.ini", "LocationFile", "UiApp")
